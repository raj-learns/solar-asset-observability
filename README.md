...
Clone the repository and go inside the project folder. Then install dependencies and start the dev server.
...
The application will start on [http://localhost:5173](http://localhost:5173) (default Vite port).
Open it in browser and you will see the performance map with date slider and side panels.
